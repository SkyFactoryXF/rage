...
methods.loadAllBlips = function () {
    ...
    methods.createBlip(new mp.Vector3(-2419.49, 3301.58, 32.83), 598, 0, 0.8, 'Army');
    ...
    methods.createBlip(new mp.Vector3(-1886.5675048828125, 2050.37890625, 140.9825897216797 - 1.0), 124, 3, 0.7, 'Mafia HQ');
    methods.createBlip(new mp.Vector3(-1516.5753173828125, 851.6640014648438, 181.5946502685547 - 1.0), 124, 1, 0.7, 'Mafia HQ');
    methods.createBlip(new mp.Vector3(-60.54205322265625, 360.08062744140625, 113.05644989013672 - 1.0), 124, 2, 0.7, 'Mafia HQ');
};